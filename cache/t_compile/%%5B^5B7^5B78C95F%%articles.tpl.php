<?php /* Smarty version 2.6.26, created on 2017-02-08 09:01:23
         compiled from file:/var/www/plugins/importexport/crossref/templates/articles.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'plugin_url', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 30, false),array('function', 'translate', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 38, false),array('function', 'url', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 60, false),array('function', 'page_info', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 90, false),array('function', 'page_links', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 91, false),array('block', 'iterate', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 48, false),array('modifier', 'strip_tags', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 60, false),array('modifier', 'strip_unsafe_html', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 61, false),array('modifier', 'escape', 'file:/var/www/plugins/importexport/crossref/templates/articles.tpl', 62, false),)), $this); ?>
...
" method="post" id="articlesForm">
		...
		<table width="100%" class="listing">
			...
			<tr class="heading" valign="bottom">
				...
				<td width="5%" align="right"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.status"), $this);?>
</td>
			</tr>
			<tr>
				<td colspan="6" class="headseparator">&nbsp;</td>
			...
			<?php $this->_tag_stack[] = array('iterate', array('from' => 'articles','item' => 'articleData')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				...
				<?php if ($this->_tpl_vars['article']->getData('crossref::registeredDoi')): ?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.export"), $this);?>
					...
					<td align="right">
						<?php if (((is_array($_tmp=$this->_tpl_vars['article']->getData($this->_tpl_vars['depositStatusUrlSettingName']))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))): ?>
...
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getData($this->_tpl_vars['depositStatusSettingName']))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
				...
				<tr>
					<td colspan="6" class="<?php if ($this->_tpl_vars['articles']->eof()): ?>end<?php endif; ?>separator">&nbsp;</td>
				</tr>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php if ($this->_tpl_vars['articles']->wasEmpty()): ?>
				<tr>
					<td colspan="6" class="nodata"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.importexport.common.export.noArticles"), $this);?>
</td>
				</tr>
				<tr>
			...
			<?php else: ?>
				<tr>
					...
					<td colspan="4" align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'articles','name' => 'articles','iterator' => $this->_tpl_vars['articles']), $this);?>
</td>
				</tr>
			<?php endif; ?>
		</table>
