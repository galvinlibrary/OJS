<?php /* Smarty version 2.6.26, created on 2016-12-01 09:38:46
         compiled from sectionEditor/submissionEmailLogEntry.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'sectionEditor/submissionEmailLogEntry.tpl', 18, false),array('function', 'translate', 'sectionEditor/submissionEmailLogEntry.tpl', 18, false),array('function', 'icon', 'sectionEditor/submissionEmailLogEntry.tpl', 50, false),array('modifier', 'date_format', 'sectionEditor/submissionEmailLogEntry.tpl', 42, false),array('modifier', 'concat', 'sectionEditor/submissionEmailLogEntry.tpl', 48, false),array('modifier', 'to_array', 'sectionEditor/submissionEmailLogEntry.tpl', 49, false),array('modifier', 'assign', 'sectionEditor/submissionEmailLogEntry.tpl', 49, false),array('modifier', 'escape', 'sectionEditor/submissionEmailLogEntry.tpl', 50, false),array('modifier', 'nl2br', 'sectionEditor/submissionEmailLogEntry.tpl', 86, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['isEditor']): ?>
	<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'editor','op' => 'clearSubmissionEmailLog','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['logEntry']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['logEntry']->getId()))), $this);?>
